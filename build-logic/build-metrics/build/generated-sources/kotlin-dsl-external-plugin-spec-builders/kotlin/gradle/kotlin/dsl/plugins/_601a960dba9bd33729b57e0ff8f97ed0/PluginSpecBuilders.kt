...
package gradle.kotlin.dsl.plugins._601a960dba9bd33729b57e0ff8f97ed0
...
/**
 * The `io.github.cdsap` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubCdsapPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.cdsap`.
 */
internal
val `IoGithubPluginGroup`.`cdsap`: `IoGithubCdsapPluginGroup`
    get() = `IoGithubCdsapPluginGroup`(plugins)


/**
 * The `io.github.cdsap.talaiot` plugin implemented by [io.github.cdsap.talaiot.plugin.TalaiotPlugin].
 */
internal
val `IoGithubCdsapPluginGroup`.`talaiot`: PluginDependencySpec
    get() = plugins.id("io.github.cdsap.talaiot")
